export declare const COMPLETION_COMMANDS: readonly ["add", "fetch", "gen", "refine", "list", "show", "search", "copy", "mcp", "edit", "rm", "rename", "export", "backup", "restore", "config", "completion", "help"];
